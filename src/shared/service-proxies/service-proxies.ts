...
@Injectable()
export class CarBrandServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    getCarBrandForEdit(id: number | undefined): Observable<CarBrandCreateEditDto> {
        let url_ = this.baseUrl + "/api/services/app/CarBrand/GetCarBrandForEdit?";
        if (id === null)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetCarBrandForEdit(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetCarBrandForEdit(<any>response_);
                } catch (e) {
                    return <Observable<CarBrandCreateEditDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<CarBrandCreateEditDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetCarBrandForEdit(response: HttpResponseBase): Observable<CarBrandCreateEditDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = CarBrandCreateEditDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<CarBrandCreateEditDto>(<any>null);
    }
     ...
     * @return Success
     */
    get(id: number | undefined): Observable<CarBrandDto> {
        let url_ = this.baseUrl + "/api/services/app/CarBrand/Get?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<CarBrandDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<CarBrandDto>><any>_observableThrow(response_);
        }));
    }

    protected processGet(response: HttpResponseBase): Observable<CarBrandDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = CarBrandDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<CarBrandDto>(<any>null);
    }
     ...
     * @return Success
     */
    getAll(keyword: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<CarBrandDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/CarBrand/GetAll?";
        if (keyword === null)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<CarBrandDtoPagedResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<CarBrandDtoPagedResultDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<CarBrandDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = CarBrandDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<CarBrandDtoPagedResultDto>(<any>null);
    }
     ...
     * @return Success
     */
    create(body: CarBrandCreateEditDto | undefined): Observable<CarBrandDto> {
        let url_ = this.baseUrl + "/api/services/app/CarBrand/Create";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCreate(response: HttpResponseBase): Observable<CarBrandDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    update(body: CarBrandCreateEditDto | undefined): Observable<CarBrandDto> {
        let url_ = this.baseUrl + "/api/services/app/CarBrand/Update";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUpdate(response: HttpResponseBase): Observable<CarBrandDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    delete(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/CarBrand/Delete?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
...
export class CountryServiceProxy {
     ...
     * @return Success
     */
    getAll(sorting: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<CountryDtoPagedResultDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<CountryDtoPagedResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<CountryDtoPagedResultDto>><any>_observableThrow(response_);
        }));
    }
    ...
    protected processGetAll(response: HttpResponseBase): Observable<CountryDtoPagedResultDto> {
        ...
        return _observableOf<CountryDtoPagedResultDto>(<any>null);
    }
     ...
     * @return Success
     */
    create(body: CountryDto | undefined): Observable<CountryDto> {
...
export class CarBrandCreateEditDto implements ICarBrandCreateEditDto {
    name: string | undefined;
    countryId: number;
    id: number;

    constructor(data?: ICarBrandCreateEditDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CarBrandCreateEditDto {
        data = typeof data === 'object' ? data : {};
        let result = new CarBrandCreateEditDto();
        result.init(data);
        return result;
    }
...
export interface ICarBrandCreateEditDto {
    name: string | undefined;
    countryId: number;
    id: number;
}
...
export class CarBrandDtoPagedResultDto implements ICarBrandDtoPagedResultDto {
    totalCount: number;
    items: CarBrandDto[] | undefined;

    constructor(data?: ICarBrandDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["items"])) {
                ...
                for (let item of _data["items"])
                    this.items.push(CarBrandDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): CarBrandDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new CarBrandDtoPagedResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): CarBrandDtoPagedResultDto {
        const json = this.toJSON();
        let result = new CarBrandDtoPagedResultDto();
        result.init(json);
        return result;
...
export interface ICarBrandDtoPagedResultDto {
    totalCount: number;
    items: CarBrandDto[] | undefined;
}
